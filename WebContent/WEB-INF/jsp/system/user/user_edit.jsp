        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <c:choose>
                        <c:when test="${fx=='head' }">
                            <input type="text" name="NUMBER" id="NUMBER" value="${pd.NUMBER }" placeholder="请选择员工编号"
                                   title="员工编号" readonly="readonly"/>
                        </c:when>
                        <c:otherwise>
                            <select class="chzn-select" onChange="selectNumber()" name="NUMBER" id="NUMBER"
                                    data-placeholder="请选择员工编号" style="vertical-align:top;">
                                <option value=""></option>
                                <c:forEach items="${numbers}" var="result">
                                    <option value="${result.EMP_CODE}"
                                            <c:if test="${result.EMP_CODE == pd.NUMBER }">selected</c:if>>${result.EMP_CODE}</option>
                                </c:forEach>
                            </select>
                        </c:otherwise>
                    </c:choose>
            ...
            <tr>
                ...
                <td>
                    <c:choose>
                    <c:when test="${fx=='head' }">
                    <input type="text" name="NAME" id="name" value="${pd.NAME }" readonly="readonly"
                           placeholder="这里输入姓名" title="姓名"/></td>
                </c:when>
                <c:otherwise>
                    <input type="text" name="NAME" id="name" value="${pd.NAME }" maxlength="32" placeholder="这里输入姓名"
                           title="姓名"/></td>
                </c:otherwise>
                </c:choose>
            </tr>
            <tr>
                <td></td>
                <td>
                    <input type="text" name="DEPT_NAME" id="deptName" value="${pd.DEPT_NAME }" title="部门"
                           readonly="readonly"/>
