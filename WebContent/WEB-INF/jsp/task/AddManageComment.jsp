...
<body>
<form action="<%=basePath%>empDailyTask/saveManageComment.do" name="Form" id="Form" method="post">
    <input type="hidden" name="manageId" value="${pd.manageId }">
    <div id="zhongxin" style="margin:20px auto;">
        <table>
            <tr>
                <td><label>分数：</label></td>
                <td>
                    <select id="score" name="score" style="width: 200px;">
